plot4 <- function() {
  ...
  twoDaysSet[,4] <- as.numeric(as.character(twoDaysSet[,4]))
  twoDaysSet[,5] <- as.numeric(as.character(twoDaysSet[,5]))
  ...
  plot(datetime,twoDaysSet[,3],type="l", xlab="", ylab="Global Active Power")
  
  plot(datetime,twoDaysSet[,5],type="l", xlab="datetime", ylab="Voltage")
  ...
  plot(datetime,twoDaysSet[,4],type="l", xlab="datetime", ylab="Global_reactive_power")
